...
namespace Plantation\Banana\Tree;
/**
...
class Mptt {
    ...
    public function __construct(&$link, $table_name = 'cherry', $id_column = 'ID', $title_column = 'Title', $left_column = 'Lft', $right_column = 'Rgt', $parent_column = 'Parent') {
        ...
        if (!extension_loaded('PDO')) trigger_error('mysqli extension is required', E_USER_ERROR);
    ...
    public function add($parent, $title, $description='',$addition=[],$position = false) {
        ...
        if (
            ...
            $this->link->exec('LOCK TABLE `' . $this->properties['table_name'] . '` WRITE');
            ...
            $node_id =  $this->link->getLastInsertId();
